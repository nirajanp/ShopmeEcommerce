...
public class UserPdfExporter extends AbstractExporter {
	...
	public void export(List<User> listUsers, HttpServletResponse response) throws DocumentException, IOException {
		...
		// PdfWriter will read the content of the document and write that to
		// response so the browser will download the response in a pdf document
		// because content type is "application/pdf"
